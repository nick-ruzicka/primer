 ...
 * (reference/_Briefing.html, extracted JSX source). This copy is the
    ...
    },
    {
      ...
      actions: [
        ...
        },
        {
          ...
          rationale: [
            t(
              "Beauty is the weakest of the three brands. Bring a side-by-side of Beauty + Active + Home so the conversation is consolidation onto , not off it.",
            ),
          ],
        },
        {
