    ...
    <div className="flex-1 overflow-y-auto bg-bg">
      <article className="mx-auto max-w-[680px] px-8 pb-20 pt-16">
        ...
        <p className="mt-4 text-[14px] text-ink-3">
          April 2026 · Nick Ruzicka · Attentive takehome
        </p>
        ...
        <Section title="The problem we're actually solving">
          <p>
            ...
            <b>synthesis</b> problem. Six source systems can agree on forty
            facts and still fail to tell you what the call is about. The gap
            between <em>fact</em> and <em>read</em> is where reps lose an hour a
            day, and where one-off prep guides stop working.
          </p>
          <p>
            ...
            call. Every claim is cited. The opinion is named. Contradictions get
            flagged by a second agent that never edits the brief — it only
            watches it.
          </p>
        </Section>
        ...
        <Section title="How it's built">
          <p>
            ...
            orchestrator fans out tool calls with a 5-second per-source timeout,
            streams Account Intelligence back immediately, then calls Claude
            (Opus) with the bundled context to write the brief. Claude-Haiku
            runs a second pass over the output + raw source data and flags
            contradictions via structured JSON.
          </p>
          <p>
        ...
        <Section title="What's next">
          <p>
            Primer's natural second lift is the <b>Pattern Analyst</b> — running
            the same tool bundle over twelve months of calls to find the shared
            failure modes across the book. This writeup expands once the live
            demo is running and Terminal 4's integration lands.
          </p>
        </Section>
      </article>
    </div>
