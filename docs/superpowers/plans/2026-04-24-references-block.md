...
```bash
cd /Users/nicholasruzicka/primer-/.worktrees/reading-view-redesign/frontend
...
```bash
sed -n '140,260p' /Users/nicholasruzicka/primer-/.worktrees/reading-view-redesign/backend/agent.py
```
...
cd /Users/nicholasruzicka/primer-/.worktrees/reading-view-redesign
...
```bash
cat /Users/nicholasruzicka/primer-/.worktrees/reading-view-redesign/frontend/components/brief/references-section.tsx
```
...
```bash
cat /Users/nicholasruzicka/primer-/.worktrees/reading-view-redesign/frontend/components/brief/reference-modal.tsx
```
...
```bash
grep -n "citations:" /Users/nicholasruzicka/primer-/.worktrees/reading-view-redesign/frontend/lib/fixtures/northstar-beauty-brief.ts | head
sed -n "/citations:/,/^  \]/p" /Users/nicholasruzicka/primer-/.worktrees/reading-view-redesign/frontend/lib/fixtures/northstar-beauty-brief.ts | head -80
```
...
```bash
ls /Users/nicholasruzicka/primer-/.worktrees/reading-view-redesign/frontend/lib/fixtures/*.ts
grep -l "citations:" /Users/nicholasruzicka/primer-/.worktrees/reading-view-redesign/frontend/lib/fixtures/*.ts
```
...
```bash
cat /Users/nicholasruzicka/primer-/.worktrees/reading-view-redesign/frontend/components/brief/prose.tsx | head -60
```
...
```bash
grep -n "markBriefDone" /Users/nicholasruzicka/primer-/.worktrees/reading-view-redesign/frontend/lib/store.ts
```
...
```bash
cd /Users/nicholasruzicka/primer-
