...
> Hey, this is Primer — a pre-call briefing product for Attentive Account
> Executives. I built it as a takehome submission, and the whole thing lives
> at one URL: the prototype and the writeup on how I built it.

> The problem is simple. An Attentive AE makes 20 calls a week, and the
...
> and never writes back. That means when Attentive's RevTech team ships
