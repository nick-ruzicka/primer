...
- Hetzner CPX21 (either your existing `5.161.116.216` or a new VM — your call)
...
```
/opt/primer/
├── app/                    # git clone of primer-attentive
│   ├── backend/
│   ├── frontend/
│   ├── mcp_servers/
│   ├── data/
...
SERVER=${PRIMER_SERVER:-root@5.161.116.216}
BRANCH=${BRANCH:-main}
...
- `primer-attentive.yourdomain.com` (explicit takehome framing)
...
- Total demo cost: $5-10 for the full takehome evaluation window
