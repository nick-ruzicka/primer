...
A pre-call briefing system for Attentive AEs. Live backend with real MCP servers, streaming brief generation via Claude, wired to the existing Claude Design frontend.

**Repo name:** `primer-attentive`
**Target:** working live demo deployed to Hetzner, takehome-ready within 4-5 days.

---

## What we're building

A V1 production-grade implementation of the pre-call briefing product. Not a prototype, not an MVP with shortcuts — the actual thing you'd ship if you worked at Attentive.
